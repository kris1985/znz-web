...
(function ($, window) {
        ...
        $.each(configure.contain, function (key, value) {
            ...
            switch (value.letter) {
                ...
                case ('Z'):
                        parameter.filterCity.Z.push(value);
                    break;
                default: parameter.filterCity._.push(value);
            }
    ...
    functionality.template = [
        ...
        '<div class="close_btn" id="close_btn"><a href="javascript:void(0);" onclick="closeSelect()">关闭</a></div>',
                ...
                '<a href="javascript:;" class="tab-a" data-letter="D">D</a>',
                '<a href="javascript:;" class="tab-a" data-letter="E">E</a>',
                '<a href="javascript:;" class="tab-a" data-letter="F">F</a>',
                '<a href="javascript:;" class="tab-a" data-letter="G">G</a>',
                '<a href="javascript:;" class="tab-a" data-letter="H">H</a>',
                '<a href="javascript:;" class="tab-a" data-letter="I">I</a>',
                 '<a href="javascript:;" class="tab-a" data-letter="J">J</a>',
                '<a href="javascript:;" class="tab-a" data-letter="K">K</a>',
                '<a href="javascript:;" class="tab-a" data-letter="L">L</a>',
                '<a href="javascript:;" class="tab-a" data-letter="M">M</a>',
                '<a href="javascript:;" class="tab-a" data-letter="N">N</a>',
                '<a href="javascript:;" class="tab-a" data-letter="O">O</a>',
                '<a href="javascript:;" class="tab-a" data-letter="P">P</a>',
				'<a href="javascript:;" class="tab-a" data-letter="Q">Q</a>',
				'<a href="javascript:;" class="tab-a" data-letter="R">R</a>',
				'<a href="javascript:;" class="tab-a" data-letter="S">S</a>',
				'<a href="javascript:;" class="tab-a" data-letter="T">T</a>',
				'<a href="javascript:;" class="tab-a" data-letter="U">U</a>',
				'<a href="javascript:;" class="tab-a" data-letter="V">V</a>',
				'<a href="javascript:;" class="tab-a" data-letter="W">W</a>',
				'<a href="javascript:;" class="tab-a" data-letter="X">X</a>',
				'<a href="javascript:;" class="tab-a" data-letter="Y">Y</a>',
				'<a href="javascript:;" class="tab-a" data-letter="Z">Z</a>',
				'<a href="javascript:;" class="tab-a" data-letter="_">#</a>',
            '</div>',
    ...
    functionality.search = function (event) {
        ...
        if (keyCode !== 13 && keyCode !== 38 && keyCode !== 40) {
            ...
            $.each(self.contain, function(key, value) {
                //拼音或者名称搜索
                if(value.pinyin.toLocaleLowerCase().search(inputVal.toLocaleLowerCase()) > -1 ){
                    result.push(value);
                }
            });

            resultHtml = result.length > 0 ? functionality.montage.call(self, result) : '<li class="not-have">没有找到<strong>'+ inputVal +'</strong>相关品牌</li>';
    ...
    functionality.searchShow = function (event) {
        ...
        this.$selector.addClass('down').find('.city-cont').css('display','none');
    ...
    $(document).on('click.cityselect', function (event) {
       /* var $citySelect = $('.city-select');
        ...
        /*if($('.city-info').css("display")=='block'){
            $('.city-info').hide();
            $("#searchTxtBtn").show();
        }*/
       // closeSelect();
