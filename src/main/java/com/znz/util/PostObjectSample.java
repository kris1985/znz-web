...
public class PostObjectSample {
    ...
    // 需要上传的本地文件，确保该文件存在
    private String localFilePath = "C:\\Users\\Public\\Pictures\\Sample Pictures\\Desert.jpg";
    // OSS域名，如http://oss-cn-hangzhou.aliyuncs.com
    private String endpoint = "http://oss-cn-shanghai.aliyuncs.com";
    // AccessKey请登录https://ak-console.aliyun.com/#/查看
    private String accessKeyId = "fuRj5S4SBVnHH9el";
    private String accessKeySecret = "AcJFEjMEvGGE9XsI9QokqIY8LITjL2AcJFEjMEvGGE9XsI9QokqIY8LITjL2";
    // 你之前创建的bucket，确保这个bucket已经创建
    private String bucketName = "testznz";
    // 上传文件后的object名称
    private String key = "kris1985";
